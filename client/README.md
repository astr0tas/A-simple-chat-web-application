### Before you start the client in dev mode, first you will need to create a self-signed SSL certificate (for local development only) by following these steps:
