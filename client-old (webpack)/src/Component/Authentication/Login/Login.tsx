            ...
            <>
                  ...
                  <Modal dismissible show={ showPopUp } onClose={ () => setShowPopUp(false) }>
                        ...
                        <Modal.Footer className="justify-center">
                              <button onClick={ () => setShowPopUp(false) } className="h-[3rem] min-w-[8rem] text-xl border-2 rounded-md bg-sky-600 text-white hover:cursor-pointer active:bg-sky-700 text-4xl max-[400px]:text-lg">Try again</button>
                        </Modal.Footer>
                  </Modal>
            </>
      )
