...
Step 6: Put all the MCP picture files in the correct folder (you can not run the 'load_file()' command if you don't do this).
	...
	If you want to create child folders in Uploads to store the pictures, you will have to change the paths in the uwc_data seeding file from 'mcpxx.jpg' to 'your_folder/../mcpxx.jpg'.
