...
Step 4: Find 'secure-file-priv'; if it does not have a value, set it back to "C:\ProgramData\MySQL\MySQL Server 8.0\Uploads\", this will allow you to only insert images which are located at C:\ProgramData\MySQL\MySQL Server 8.0\Uploads.
Step 5: Save and exit the file.
Step 6: Press Window + R and search for services.msc, locate mysql and MySQL80 and restart both of them.
